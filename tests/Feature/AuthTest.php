...
class AuthTest extends TestCase
{
    ...
    public function test_user_info(): void
    {
        ...
        $this->asertEquals($response->json('name'),$user->name);
        $this->asertEquals($response->json('email'),$user->email);
    }
    ...
    public function test_user_register_error(): void
    {
        ...
        $this->assertEquals($message, 'Password and Confirm Password must be same.');
